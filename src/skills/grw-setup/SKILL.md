...
figure nel roster degli agenti, l'installazione delle stanze tematiche di party mode e la
proposta del passo di profilazione. L'esito che conta non è il file di config — è che l'utente
sappia come eseguire `grw-profile`, perché senza profilo di progetto le figure parlano per luoghi
...
4. Procedi senza domande di configurazione. La severità si deriva dalla criticità dichiarata nel
   ...
   il default operativo resta `normal` e il setup propone `grw-profile`.
