---
name: grw-profile
description: Crea e aggiorna il profilo di progetto del modulo Guardrails. Usa quando l'utente dice "profila il progetto", "crea il profilo Guardrails", "aggiorna il profilo di progetto", invoca "grw-profile", oppure quando una figura Guardrails segnala che il profilo di progetto manca.
---
...
tu sai quali otto cose le cinque figure del modulo devono sapere per non parlare per luoghi
...
regola quanto saranno severe tutte e cinque. La conversazione dura pochi minuti: se sembra un
...
- Chiudi mostrando il profilo e due righe: la severità di default che ne deriva (la
  mappatura è nel template) e che le cinque figure ora hanno contesto.
...
- Se cambia la criticità, dillo esplicitamente: cambia la severità di tutte e cinque le figure.
