...
tu sai quali otto cose le tre figure del modulo devono sapere per non parlare per luoghi
...
regola quanto saranno severe tutte e tre. La conversazione dura pochi minuti: se sembra un
...
mappatura è nel template) e che le tre figure ora hanno contesto.
...
- Se cambia la criticità, dillo esplicitamente: cambia la severità di tutte e tre le figure.
